...
# Set OUTPUT env var to control output path (default: benches/results.md).
set -euo pipefail
...

{
    ...
    echo ""
    echo "All benchmarks: warm cache (\`--warmup 3\`), output to pipe. NDJSON uses parallel processing."
...
echo "=== Done ==="
echo "Wrote ${OUTPUT:-benches/results.md}"
